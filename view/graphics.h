...
void update_data_texture_quad(uint16_t *, RenderData *, QuadTree *, Quad *, uint32_t, uint32_t, uint32_t, uint32_t);
void update_data_texture_leaf(uint16_t *, RenderData *, QuadTree *, Leaf *, uint32_t, uint32_t, uint32_t, uint32_t);
